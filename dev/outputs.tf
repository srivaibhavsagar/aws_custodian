...
output "S3_BUCKET_TERRAFORM_NAME"{
    value = module.s3_bucket_deploy.bucket_name
}

output "CODEBUILD_FETCHSOURCE_NAME"{
    value = module.code-build.codebuild_fetchsource_name
}

output "CODEBUILD_DEPLOY_NAME"{
    value = module.code-build.codebuild_deploy_name
}

output "CODEBUILD_SMOKETESTS_NAME"{
    value = module.code-build.codebuild_smoke_name
}

output "CODEPIPELINE_NAME_WITHSMOKETEST"{
    value = module.code-pipeline.codepipeline_name_withsmoketest
}

output "CODEPIPELINE_NAME_WITHNOSMOKETEST"{
    value = module.code-pipeline.codepipeline_name_withnosmoketest
}
